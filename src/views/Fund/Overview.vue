            ...
            <el-tree
              ...
              <span
                ...
                <el-tooltip
                  ...
                  placement="right">
                  <div slot="content">
                    <div class="margin-bottom-5">{{ data.name }} (投资回报率目标达成率) : {{ calculatePercent(data.real_total, data.target_total).percent + '%' }}</div>
...
import Budget from './OverviewMenu/Budget.vue';
