    ...
    <div class="optimization">
      <el-row
        ...
        <el-col
          ...
          <div class="title">资金周转率环比增长率(策略有效性)</div>
            ...
            <el-tree
              ...
              <span
                ...
                <el-tooltip
                  ...
                  placement="right">
                  <div slot="content">
                    <div class="margin-bottom-5">{{ data.name }} (资金周转率环比增长率) : {{ calculatePercent(data.real_total, data.target_total).percent + '%' }}</div>
...
export default {
    ...
    computed: {
        ...mapGetters(['fundTree','fundhistoryArr','fundAchievementOpt']),
        hasTree() {
        ...
        noStandard(){
            if (this.fundAchievementOpt != null) {
                return (this.fundAchievementOpt * 100).toFixed(0) +'%'  ;
            } else {
                return '暂无';
            }
        }
    ...
    methods: {
        ...
        getColSpan(item,index) {
            ...
            if (this.fundhistoryArr[index+1] && this.fundhistoryArr[index+1].strategies.length && ((index + 1) % 2)) {
                return 24;
            }
            return 12;
        },
