    ...
    <div class="overview">
      <el-row
        ...
        <el-col
          ...
          <div class="title">客户利润额目标未达成数 : {{ cusAchievement }} </div>
            ...
            <el-tree
              ...
              <span
                ...
                <el-tooltip
                  ...
                  placement="right">
                  <div slot="content">
                    <div class="margin-bottom-5">{{ data.name }} (利润额目标达成率) : {{ calculatePercent(data.real_total, data.target_total).percent + '%' }}</div>
                ...
                <div
                  :class="{progress: true, 'is-active': activeCid == data.cid, 'is-active-bad': arr.includes(data.cid),'border-radius-0': calculatePercent(data.real_total, data.target_total).largerThanOne}"
...
//tree 百分比计算
import { calculatePercent, error, preOrder, find,findP, addProperty, echartAndSliderResize } from 'utils/common';
//vuex
...
export default {
    ...
    computed: {
        ...mapGetters(['customerTree', 'cusAchievement']),
        hasTree () {
