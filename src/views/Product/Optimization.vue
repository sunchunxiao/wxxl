							...
							<el-col :span="12" :key="index">
								<el-table :data="tableData2" size="mini" :span-method="arraySpanMethod2">
									<el-table-column :label="time">
										<el-table-column prop="subject" label="指标"></el-table-column>.
										<el-table-column prop="package" label="影响因素">
										</el-table-column>
										<el-table-column prop="strategy" label="应用策略"></el-table-column>
										<el-table-column prop="rank" label="评选结果"></el-table-column>
										<el-table-column prop="ring_rate" label="环比增长率">
