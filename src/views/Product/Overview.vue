    ...
    <div class="overview">
      <el-row
        ...
        <el-col
          ...
          <div class="title">毛利润额目标未达成数 :{{ productAchievement }} </div>
            ...
            <el-tree
              ...
              <span
                ...
                <el-tooltip
                  ...
                  placement="right">
                  <div slot="content">
                    <div class="margin-bottom-5 ">{{ data.name }} (毛利润额目标达成率) : {{ calculatePercent(data.real_total, data.target_total).percent + '%' }}</div>
...
export default {
    ...
    computed: {
        ...mapGetters(['productTree','productAchievement']),
        hasTree () {
