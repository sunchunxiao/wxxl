    ...
    <div class="overview">
      ...
      <el-row
        ...
        <el-col
          ...
          <PlanBudgetBar
            :id="`planDepartment`"
            v-if="planDepartmentData.planData && planDepartmentData.planData.length"
            :data="planDepartmentData" />
        </el-col>
      </el-row>
      <el-row
        class="mgb10 wrap"
        ...
        <el-col
          ...
          <PlanBudgetBar
            v-if="planFactoryData.planData && planFactoryData.planData.length "
            :id="`planFactoryData`"
            :data="planFactoryData" />
        </el-col>
      </el-row>
      <div class="capacity">
        <div
...
export default {
    ...
    computed: {
        ...mapGetters(['planFactory','planCapacity']),
    },
    mounted() {
        this.fliter();
    },
    ...
    methods: {
        ...
        getPlanDepartment(form) {
            ...
            API.GetPlanDepartment(params).then(res => {
                this.planDepartmentData = res.data;
            }).finally(() => {
                this.loading = false;
            });
        },
