            ...
            <el-tree
              ...
              <span
                ...
                <el-tooltip
                  ...
                  placement="right">
                  <div slot="content">
                    <div class="margin-bottom-5">{{ data.name }} (投入产出比目标达成率) : {{ calculatePercent(data.real_total, data.target_total).percent + '%' }}</div>
            ...
            <Card>
              ...
              <el-row v-if="hasConstarst">
                ...
                <ConOrgComparisonAverageBig
                  ...
                  :unit="getUnit(orgcompareArr[index0], orgSubject)"
                  :index="index0" />
              </el-row>
              <el-row
            ...
            <Card
              ...
              <el-row
                ...
                <ConOrgComparisonAverageBig
                  ...
                  :unit="getUnit(orgcompareArrback[index1], orgBackSubject)"
    ...
    methods: {
        ...
        getCompare () {
            ...
            Promise.all(promises).then(resultList => {
                ...
                this.$store.dispatch('SaveOrgCidObj',_.cloneDeep(lastCidObjArr));
