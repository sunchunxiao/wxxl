    ...
    <div class="optimization">
      <el-row
        ...
        <el-col
          ...
          <div class="title">渠道结构日销环比增长率 :{{ noStandard }} </div>
...
export default {
    ...
    computed: {
        ...mapGetters(['channelTree', 'channelHistoryArr','channelAchievementOpt']),
        hasTree () {
    ...
    methods: {
        ...
        getAchievement() {
            ...
            API.GetChannelAchievement(params).then(res => {
                this.$store.dispatch('SaveChannelAchievementOpt', res.data);
            });
        },
        getColSpan(item,index) {
            ...
            if (this.channelHistoryArr[index+1] && this.channelHistoryArr[index+1].strategies.length && ((index + 1) % 2)) {
                return 24;
            }
            return 12;
        },
