      ...
      <el-row
            ...
            <el-tree
              ...
              <span
                ...
                <el-tooltip
                  ...
                  placement="right">
                  <div slot="content">
                    <div class="margin-bottom-5">品类:{{ data.name }} (营业利润额目标达成率) : {{ calculatePercent(data.real_total, data.target_total).percent + '%' }}</div>
        ...
        <el-col
          ...
          <div
            ...
            <Card>
              <el-row class="margin-bottom-20">渠道对比分析和平均值分析</el-row>
