    ...
    <div class="overview">
      <el-row
        ...
        <el-col
          ...
          <div class="title">渠道营业利润额目标未达成数 :{{ channelAchievement }} </div>
            ...
            <el-tree
              ...
              <span
                ...
                <el-tooltip
                  ...
                  placement="right">
                  <div slot="content">
                    <div class="margin-bottom-5">{{ data.name }} (营业利润额目标达成率) : {{ calculatePercent(data.real_total, data.target_total).percent + '%' }}</div>
...
export default {
    ...
    computed: {
        ...mapGetters(['channelTree', 'channelAchievement']),
        hasTree () {
    ...
    methods: {
        ...
        handleClick(id) {
            this.currView = id;
            this.$router.push(`/sixBasicsEngine/channel/overview/${id}`);
        },
        allRequest() {
